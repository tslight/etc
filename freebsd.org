...
#+begin_src conf :tangle ~/.ratpoisonrc
  ...
  definekey top XF86MonBrightnessDown 'sudo backlight - 10'
  definekey top XF86MonBrightnessUp 'sudo backlight + 10'
  definekey top XF86AudioMute 'mixer vol.mute=toggle'
  definekey top XF86AudioLowerVolume 'mixer vol.volume=-5%'
  definekey top XF86AudioRaiseVolume 'mixer vol.volume=+5%'
#+end_src
