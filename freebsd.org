...
#+begin_src conf :tangle ~/.fvwm/local.config
  ...
  + "&Emacs%icons/terminal.png%" Exec exec $[infostore.editor]
  + "&Browser%icons/terminal.png%" Exec exec $[infostore.browser]
  + "&Terminal%icons/terminal.png%" Exec exec $[infostore.editor]
  + "&Run Command%icons/run_arrow.png%" Exec exec $[infostore.runcmd] $[infostore.runcmdopt]
  ...
  Key Return  A 4  Exec exec $[infostore.editor]
  Key Return  A 4C Exec exec $[infostore.browser]
  Key Return  A 4M Exec exec $[infostore.terminal]
  Key Space   A 4  Exec exec $[infostore.runcmd]
  Key Space   A M  # Keep for Emacs' space cycling
  Key Super_R A A  # Don't steal right Super key please
  Key F4      A M  Close
