...
#+begin_src conf :tangle /sudo::/etc/make.conf
  KERNCONF=GENERIC-NODEBUG
  ALLOW_PKGBASE_INSTALLKERNEL=yes
#+end_src

#+begin_src conf :tangle /sudo::/etc/src.conf
...
#+begin_src sh :tangle /sudo::/etc/crontab
...
%operator ALL=(ALL:ALL) NOPASSWD: /usr/bin/backlight
#+end_src
...
#+name: :tangle /sudo::/usr/share/vt/keymaps/jp.emacs.macbook.kbd :tangle-mode o444
#+begin_src conf
#                                                         alt
...
#+name: :tangle /sudo::/usr/share/vt/keymaps/us.emacs.macbook.kbd :tangle-mode o444
#+begin_src conf
  #                                                         alt
  # scan                       cntrl          alt    alt   cntrl lock
  # code  base   shift  cntrl  shift  alt    shift  cntrl  shift state
...
#+name: conf :tangle /sudo::/usr/local/etc/X11/xorg.conf.d/50-intel.conf
#+begin_src
  Section "Device"
	  Identifier "Card0"
	  Driver     "intel"
...
#+begin_src conf :tangle /sudo::/usr/local/etc/X11/xorg.conf.d/50-serverflags.conf
  Section "ServerFlags"
...
#+begin_src conf :tangle /sudo::/usr/local/etc/X11/xorg.conf.d/50-libinput-kbd.conf
  Section "InputClass"
...
#+name: :tangle /sudo::/usr/local/share/X11/xkb/symbols/hangul
#+begin_src conf
...
#+name: :tangle /sudo::/usr/local/share/X11/xkb/symbols/leftmods
#+begin_src conf
...
#+begin_src conf :tangle /sudo::/usr/local/etc/X11/xorg.conf.d/50-libinput-tp.conf
  Section "InputClass"
