...
#+begin_src conf :tangle ~/.fvwm/local.config
  ...
  InfoStoreAdd editor "emacsclient -c -a ''"
  ...
  + "&Terminal%icons/terminal.png%" Exec exec xterm
  + "&Emacs%icons/terminal.png%" Exec exec $[infostore.editor]
  + "&Browser%icons/terminal.png%" Exec exec librewolf
  ...
  Key Return  A 4C Exec exec emacs
