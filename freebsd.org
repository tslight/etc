...
#+begin_src conf :tangle /sudo::/usr/share/vt/keymaps/us.macbook.spcdt.kbd
  #                                                         alt
...
#+BEGIN_SRC conf :tangle /sudo::/usr/share/vt/keymaps/uk.thinkpad.spcdt.kbd
# $FreeBSD$
#                                                         alt
# scan                       cntrl          alt    alt   cntrl lock
# code  base   shift  cntrl  shift  alt    shift  cntrl  shift state
...
=:tangle no= whilst I figure things out...
