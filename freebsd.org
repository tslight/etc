...
#+begin_src conf :tangle ~/.fvwm/local.config
  ...
  + "&FvwmPrompt%icons/terminal.png%" Exec exec $[infostore.terminal] -e FvwmPrompt
  ...
  Mouse 1 S A RaiseMove Move
  Mouse 3 FS A Menu MenuWindowOpsLong

  OpaqueMoveSize 0
  Style * !ResizeOpaque, !Title, Icon, HandleWidth 8
