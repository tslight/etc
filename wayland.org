...
#+begin_src kdl :tangle ~/.config/niri/config.kdl
  ...
  binds {
      ...
      Mod+E                 hotkey-overlay-title="Focus or Spawn Emacs" { spawn "niri-rorr.sh" "emacs"; }
      Mod+Ctrl+E            hotkey-overlay-title="Open Emacs Client" { spawn "emacsclient" "-a" "'emacs'" "-c" "-n"; }
      Mod+T                 hotkey-overlay-title="Focus or Spawn Kitty" { spawn "niri-rorr.sh" "kitty"; }
      Mod+Ctrl+T            hotkey-overlay-title="Open Terminal: Kitty" { spawn "kitty"; }
      Mod+W                 hotkey-overlay-title="Focus or Spawn Firefox" { spawn "niri-rorr.sh" "firefox"; }
      Mod+Ctrl+W            hotkey-overlay-title="Open Browser: firefox" { spawn "firefox"; }
...
#+begin_src shell :tangle /sudo::/usr/local/bin/niri-rorr.sh :tangle-mode (identity #o755)
#!/bin/sh
APP=$1
...
#+begin_src toml :tangle ~/.config/noctalia/config.toml
  [bar.default]
