...
[bar.default]
capsule_thickness = 0.10000000149011612
center = [ "taskbar" ]
...
radius = 0
shadow = false
start = [ "clock", "battery", "temp", "launcher", "wallpaper", "workspaces" ]
thickness = 48
...
[widget.taskbar]
icon_scale = 2.0
inactive_opacity = 0.79000000000000004
pinned = [ "Alacritty", "firefox", "emacs" ]
pinned_opacity = 0.73999999999999999
