...
Next, clone the [[https://github.com/tslight/stumpwm-contrib][stumpwm-contrib]] repository to ~$HOME/src~, to be able use
ttf-fonts, cycle-mru, sensors and stumptray.
