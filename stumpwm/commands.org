...
#+PROPERTY: header-args+ :tangle ~/.stumpwm.d/commands.lisp
...
#+BEGIN_SRC common-lisp
  ...
  (defcommand swank () ()
    ...
    (swank:create-server :port 4004
                         ...
                         :dont-close t)
    (message (concat "^B^5Getting swanky...~%^n" (my/random-courage))))
#+END_SRC
...
#+BEGIN_SRC common-lisp
  ...
  (defun my/random-courage ()
    "Return a random courage message."
    (my/random-elt words-of-encouragement))

  (defcommand my/stump-courage () ()
    "Print a slime hacker quote."
    (message "~a" (my/random-courage)))
#+END_SRC
