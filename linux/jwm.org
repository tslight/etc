...
#+BEGIN_SRC xml :tangle ~/.jwmrc
  ...
  <JWM>
    ...
    <RootMenu onroot="12">
      ...
      <Menu label="Emacs">
        <Program label="Emacs">lilyterm -x emacs -nw</Program>
        <Program label="Emacs Quick">lilyterm -x emacs -nw -q</Program>
        <Program label="Emacs Debug">lilyterm -x emacs -nw --debug-init</Program>
        <Program label="Emacs Daemon">lilyterm -x emacsclient -nw -c -a ""</Program>
      ...
      <Program label="Tmux">lilyterm -x tmux</Program>
      <Program label="Term">lilyterm</Program>
      <Program label="Lock">slock</Program>
      <Menu label="Utilities">
        <Program label="Fonts">xfontsel</Program>
        <Restart label="Restart WM"/>
        <Program label="XEventViewer">lilyterm -x xev</Program>
    ...
    <Key mask="4" key="Return">exec:lilyterm</Key>
    <Key mask="4" key="e">exec:emacsclient -c -a ""</Key>
    <Key mask="4C" key="e">exec:emacs</Key>
    <Key mask="4" key="t">exec:lilyterm -x tmux</Key>
    <Key mask="4C" key="t">exec:lilyterm -x tmux attach</Key>
