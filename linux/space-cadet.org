...
[[http://xahlee.info/kbd/space-cadet_keyboard.html][Space-Cadet]] Lisp Machine keyboard layout. The was the keyboard Emacs' was
...
#+BEGIN_SRC conf
  ...
  evdev:atkbd:dmi:bvn*:bvr*:svnHP*:pnHP*ProBook*430*G6*
   ...
   KEYBOARD_KEY_cb=rightmeta        # left  --> rightmeta
#+END_SRC
