...
https://forum.manjaro.org/t/solved-manjaro-brightness-hotkey-is-writing-to-intel-backlight-instead-of-gmux-backlight/62365/8
#+NAME: intel
#+BEGIN_SRC conf :tangle (my/hardware-tangle "Apple Inc" "/sudo::/usr/share/X11/xorg.conf.d/20-intel.conf")
  Section "Device"
  ...
  EndSection
#+END_SRC
#+BEGIN_SRC conf :noweb yes :tangle (my/hardware-tangle "Apple Inc" "/sudo::/etc/X11/xorg.conf.d/20-intel.conf")
  <<intel>>
#+END_SRC
...
#+NAME: libinput
#+BEGIN_SRC conf :tangle (my/hardware-tangle "Apple Inc" "/sudo::/usr/share/X11/xorg.conf.d/30-touchpad.conf")
  Section "InputClass"
      Identifier "Touchpad"
      Driver "libinput"
      MatchIsPointer "on"
  ...
  EndSection
#+END_SRC
#+BEGIN_SRC conf :noweb yes :tangle (my/hardware-tangle "Apple Inc" "/sudo::/etc/X11/xorg.conf.d/30-touchpad.conf")
  <<libinput>>
#+END_SRC
...
#+BEGIN_SRC conf :tangle (my/hardware-tangle "Apple Inc" "/sudo::/usr/share/X11/xorg.conf.d/50-mtrack.conf")
  ...
  EndSection
#+END_SRC
#+BEGIN_SRC conf :noweb yes :tangle (my/hardware-tangle "Apple Inc" "/sudo::/etc/X11/xorg.conf.d/50-mtrack.conf")
  <<mtrack>>
#+END_SRC
* MONITOR
