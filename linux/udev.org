...
*Super > Meta/Alt > Ctrl > S P A C E < Ctrl < Meta/Alt < Super*
...
#+BEGIN_SRC conf
  # Lenovo ThinkPad T450
  evdev:atkbd:dmi:bvn*:bvr*:bd*:svnLENOVO:pn*:pvrThinkPadT450
...
#+BEGIN_SRC conf
  # Lenovo ThinkPad T420
  evdev:atkbd:dmi:bvn*:bvr*:bd*:svnLENOVO:pn*:pvrThinkPadT420
   KEYBOARD_KEY_01=capslock  # esc   --> caps
   KEYBOARD_KEY_3a=esc       # caps  --> esc
