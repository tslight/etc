...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    :bind
    ("<tab>" . (lambda () (interactive) ;; USE CTRL-I FFS or the sake of your pinkies!
		 (message "YOU HAVE FORGOTTEN THE FACE OF YOUR FATHER")))
    ("<return>" . (lambda () (interactive) ;; USE CTRL-J FFS or the sake of your pinkies!
		    (message "YOU HAVE FORGOTTEN THE FACE OF YOUR FATHER")))
    ("<backspace>" . (lambda () (interactive) ;; USE CTRL-H FFS or the sake of your pinkies!
		       (message "YOU HAVE FORGOTTEN THE FACE OF YOUR FATHER")))
...
#+begin_src emacs-lisp
  ...
  (keymap-global-set "C-x h" 'my/save-whole-buffer)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package copilot-chat :ensure
    :custom (copilot-chat-default-model "claude-opus-4.5")
