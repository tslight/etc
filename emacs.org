...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    ;; prevent backspace being hijacked by ^H on a tty
    (when (not window-system) (normal-erase-is-backspace-mode))
    ...
    :hook
    ((prog-mode shell-script-mode) . hl-line-mode))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package nix-ts-mode :ensure :mode ("\\.nix\\'" . nix-ts-mode))
