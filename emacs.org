...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    ("C-x C-b" . switch-to-buffer) ;; DWIW!
    ("C-x M-b" . ibuffer)
    ("C-x m" . man) ;; run sudo makewhatis or mandb
    ("C-x x s" . sort-lines)
    ("C-x M-k" . kill-buffer)
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-c d" 'my/delete-inside-delimiters)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-c f d" 'my/delete-this-file)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-c l" 'my/last-buffer)
  (bind-key* "C-<escape>" 'my/last-buffer)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-c f w" 'my/save-filename)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (bind-key* "C-x M-w" 'my/save-whole-buffer)
#+end_src
...
#+begin_src emacs-lisp
  (use-package clang-format :ensure
    ...
    :config
    (when (executable-find "clang-format19")
      (setq clang-format-executable "clang-format19"))
