...
#+begin_src emacs-lisp
  (use-package emacs
    ...
    (auto-save-file-name-transforms nil) ; https://emacs.stackexchange.com/a/79031
    (backup-directory-alist '(("." . (concat user-emacs-directory "backups"))))
    (completion-styles '(basic substring initials flex))
    (custom-file (expand-file-name "custom.el" user-emacs-directory))
    (default-frame-alist '((fullscreen . fullscreen)))
    ...
    (frame-resize-pixelwise t) ; proper maximize in some wm
...
(defun my/after-make-frame (frame)
  ...
  (when (daemonp) (add-hook
		   'after-make-frame-functions
		   #'my/after-make-frame (selected-frame)))
#+end_src
** my/delete-inside-delimiters
#+begin_src emacs-lisp
...
#+end_src
** my/kill-ring-save-whole-buffer
#+begin_src emacs-lisp
  (defun my/kill-ring-save-whole-buffer ()
    "Save the entire contents of the buffer to the kill ring."
    (interactive)
    (kill-ring-save (point-min) (point-max))
    (message "Saved whole buffer to kill ring :-)"))
  (keymap-global-set "C-c h" 'my/kill-ring-save-whole-buffer)
#+end_src
** my/last-buffer
#+begin_src emacs-lisp
...
** my/yank-filename
#+begin_src emacs-lisp
  (defun my/yank-filename (arg)
    "Yank current buffer filename. With prefix ARG, omit path."
    (interactive "P")
  ...
  (keymap-global-set "C-c f w" 'my/yank-filename)
#+end_src
* DIRED
...
#+begin_src emacs-lisp
  (use-package dired
    ...
    ;; omit all dotfiles instead of just . & ..
    (dired-omit-files "\\`[.]?#\\|\\`[.][.]?\\'\\|^\\..+$")
...
#+begin_src emacs-lisp
  ...
  (use-package exec-path-from-shell :ensure :hook (after-init . exec-path-from-shell-initialize))
