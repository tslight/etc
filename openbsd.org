...
#+BEGIN_SRC conf :tangle /sudo::/etc/wsconsctl.conf
  #	$OpenBSD: wsconsctl.conf,v 1.2 2021/03/24 18:50:54 bru Exp $
  #
  ...
  mouse1.tp.tapping=1,3,2		# enable tapping with default button mappings;
...
#+name :tangle /sudo::/etc/X11/xenodm/xenodm-config :tangle-mode (identity #o644)
#+BEGIN_SRC conf
...
#+name :tangle ~/.xmodmap/space_cadet.kbd
#+BEGIN_SRC conf
