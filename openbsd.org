...
#+BEGIN_SRC conf :tangle ~/.cwmrc
  ...
  bind-key 4-t 'tabbed -c xterm -into'
  ...
  bind-key C-Escape window-cycle
  bind-key CS-Escape window-rcycle
  bind-key M-Escape group-cycle
  bind-key MS-Escape group-rcycle
  bind-key 4-Escape window-cycle-ingroup
  bind-key 4S-Escape window-rcycle-ingroup
  ...
  command 'xterm' 'tabbed -c xterm -into'
  command 'xlock' 'xlock'
  command 'sleep' 'zzz'
