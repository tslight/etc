...
The culmination of years of procrastination and [[http://projects.csail.mit.edu/gsb/old-archive/gsb-archive/gsb2000-02-11.html][yak-shaving]]...

All in one handy dandy git repo. Amazeballs.

* How does all this work?

Basically, I'm using Emacs' amazing org-mode as a configuration file
management system.
...
The main functions were stolen from this guy's blog:
...
#+CAPTION: BSD vs. Linux, Any questions?
#+NAME:fig:death to butterflies
     [[./img/bsd-vs-linux.jpg]]

Evil proprietary systems are also catered for...

Cupertino's wickedness resides [[file:macos/README.org][here]], whilst Redmonds unutterable
ghastliness dwells in [[file:windows/README.org][this]] unspeakable den of inquity.
