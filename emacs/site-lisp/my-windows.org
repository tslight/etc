...
#+BEGIN_SRC emacs-lisp
  (my/bind "C-x O" my/prev-window)
  (my/bind "C-c 3" my/vsplit-last-buffer)
  (my/bind "C-c 2" my/hsplit-last-buffer)
  (my/bind "M-<" my/top-of-window)
  (my/bind "M->" my/bottom-of-window)
