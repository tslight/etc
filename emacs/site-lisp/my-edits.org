...
#+BEGIN_SRC emacs-lisp
  (my/bind "C-x RET u" my/convert-to-unix-coding-system)
  (my/bind "C-S-SPC" my/push-mark-no-activate)
  (my/bind "C-c M-p" my/change-pairs)
  (my/bind "C-c a" my/align-symbol)
  (my/bind "C-c =" my/align-equals)
  (my/bind "C-c :" my/align-colon)
  (my/bind "C-c #" my/align-numbers)
  (my/bind "C-c d" my/delete-inside)
  (my/bind "C-c k" my/remove-from-buffer)
  (my/bind "C-c u" my/underline-text)
  (my/bind "M-s M-s" my/surround)
  (my/bind "C-o" my/open-line-above)
  (my/bind "C-S-o" my/open-line-below)
  ;; (my/bind "C-y" my/yank)
  ;; (my/bind "C-M-y" (lambda () (interactive) (my/yank t)))
  (my/bind "M-Q" my/unfill-region)
#+END_SRC
