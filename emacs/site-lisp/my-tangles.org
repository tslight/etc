...
Finds the directory in ~my/config-directory~ that matches a substring of
...
If the file is in my site-lisp directory also insert a provide expression, so
that the FILE can be loaded as a package.
                ...
                (progn
                  (let* ((filename (file-name-sans-extension
                         ...
                         (header (concat ";;; " filename ".el ---\n\n"
                                         ...
                                         ";;; Code:\n"
                                         ";; -*- lexical-binding: t; -*-\n"))
                         (footer (concat "(provide '" filename ")\n"
...
Byte compile init file and site-lisp directory and then load the newly compiled
configuration.
