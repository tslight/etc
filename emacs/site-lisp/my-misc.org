...
#+begin_src emacs-lisp
  (defun my/get-next-page-link ()
    (beginning-of-buffer)
    (let ((begin (re-search-forward "Link: <"))
  ...
  (defun my/url-retriever (url &optional headers)
    ...
    (set-buffer
     (let ((url-request-method "GET")
       ...
       ;; (my/url-retriever (my/get-next-page-link) headers)
       ))
    (let ((next-page (my/get-next-page-link)))
      (if next-page
          (my/url-retriever next-page headers)))
    (my/cleanup-buffer))

  (my/get-next-page-link)
