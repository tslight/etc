...
#+BEGIN_SRC emacs-lisp
  (my/bind-always "C-c e b" eval-buffer)
  (my/bind-always "C-c e c" eval-current-buffer)
  (my/bind-always "C-c e e" pp-eval-last-sexp)
  (my/bind-always "C-c e f" eval-defun)
  (my/bind-always "C-c e m" lisp-interaction-mode)
  (my/bind-always "C-c e r" eval-region)
...
#+BEGIN_SRC emacs-lisp
  ...
  (my/bind-always "C-c t l" linum-mode)
...
#+BEGIN_SRC emacs-lisp
  ;; (my/bind-always "C-<tab>" next-buffer)
  ;; (my/bind-always "C-<iso-lefttab>" previous-buffer)
