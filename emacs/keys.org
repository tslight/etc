...
#+BEGIN_SRC emacs-lisp
  (when (>= emacs-major-version 27)
    (my/bind "C-S-t" tab-bar-new-tab)
    (my/bind "C-S-w" tab-bar-close-tab)
    (my/bind "C-`" tab-bar-switch-to-recent-tab)
    (my/bind "C-<tab>" tab-bar-switch-to-next-tab)
    (my/bind "C-<iso-lefttab>" tab-bar-switch-to-previous-tab))
#+END_SRC
...
Don't use ~my/bind~ for these as I end up clobbering ~vterm~ and ~ansi-term~.

#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "C-r") 'isearch-backward-regexp)
  (global-set-key (kbd "C-s") 'isearch-forward-regexp)
  (global-set-key (kbd "C-M-r") 'multi-isearch-buffers-regexp)
  (global-set-key (kbd "C-S-r") 'multi-isearch-files-regexp)
